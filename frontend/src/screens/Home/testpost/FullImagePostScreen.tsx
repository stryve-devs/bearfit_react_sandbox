...
export default function FullImagePostScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity activeOpacity={1} onPress={toggleControls} style={styles.imageWrap}>
      ...
      <Animated.View style={[styles.bottomBar, controlsStyle]}>
        <SafeAreaView edges={["bottom"]} style={styles.bottomBarInner}>
          ...
          <View style={styles.bottomActions}>
            ...
            />
            <ActionBtn icon="ellipsis-horizontal" label="More" onPress={() => Haptics.selectionAsync()} />
          </View>
        </SafeAreaView>
      </Animated.View>
    </View>
